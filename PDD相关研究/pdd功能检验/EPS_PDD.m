function [ pressure_PDD, demand_PDD ] = EPS_PDD(circulation_num,doa,Hmin,Hdes,net_data,temp_t,real_demand,based_demand )
...
for i = 1:circulation_num
    ...
    [~,bdemand1]=Get(junction_num,9);%实际需水量
